...
const SharedTransition = (
  ...
  const width = createInterpolate([position.width, windowWidth + offsetX]);
  const height = createInterpolate([position.height, windowHeight + offsetY]);
